...
async def gpt_call(labels: list, message_subject: str, message_content: str) -> str:
    message = {
        'role': 'user',
        'content': f'''
...
async def gpt_call_filter_by_sender(label: str, message_subject: str, message_content: str) -> str:
    message = {
        'role': 'user',
        'content': f'''
        You are a professional email sorter.
